import type { EntityState, IdSelector, Update, EntityId } from 'utils/entities/models'
...
//   newEntities: readonly TransactionPayload<T>[] | Record<EntityId, TransactionPayload<T>>,
