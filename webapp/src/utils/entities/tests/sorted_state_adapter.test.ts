import type { EntityStateAdapter, EntityState } from 'utils/entities/models'
import { createEntityAdapter } from 'utils/entities/create_adapter'
...
import {
  ...
  AnimalFarm,
  TheHobbit,
} from 'utils/entities/tests/fixtures/book'
