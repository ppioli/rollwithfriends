...
export type EntryList_rootQuery$data = {
  readonly entries: {
  ...
  readonly " $fragmentType": "EntryList_rootQuery";
};
export type EntryList_rootQuery$key = {
  readonly " $data"?: EntryList_rootQuery$data;
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__RootQuery_entries_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
